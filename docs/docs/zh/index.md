...
features:
  ...
  - title: 注重细节
    details: 按下与抬起各拥有独立音效，完美适配长按场景。细微的随机音量浮动让每次敲击都充满生命感。
  - title: 强大的专辑编辑器
    details: 波形可视化裁剪，支持拖拽选区、前端试听播放条和 dB 音量指针条。随机/顺序播放模式让声音组合无限多变。
  - title: 多语言支持（16 种）
    details: 完整支持 16 种界面语言，含阿拉伯语 RTL 布局。在设置中即可切换，无需重启。
  - title: 签名与加密专辑
    details: .ktalbum 格式包含作者签名与配置加密，保护专辑完整性，防止分享过程中被篡改。
  - title: 代码开源
    details: 完全基于 GPL v3 开源，欢迎体验并加入我们的开源社区！
    linkText: 源码地址
    link: https://github.com/LuSrackhall/KeyTone
---
