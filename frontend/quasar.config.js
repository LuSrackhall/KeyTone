  ...
  return {
    ...
    electron: {
      ...
      builder: {
        ...
        artifactName: 'KeyTone-${version}-wails-${os}-${arch}.${ext}', // 这个配置是用于定义生成的文件名模板。artifactName 可以包含变量，比如 ${version} 会用应用程序的版本号替换，${os} 会用目标操作系统替换，${ext} 会用文件的扩展名替换。这样，生成的安装文件名能清楚地反映出版本信息和适用的操作系统。
        extraFiles: {
